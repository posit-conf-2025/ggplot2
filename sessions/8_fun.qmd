...
::: {.text-center .plain}
:::::: {.btn-group}
[Slides](../slides/8_fun.qmd){.btn .btn-primary role="button"}
...
[<i class="bi bi-caret-left"></i> Previous session](../sessions/7_extensions.qmd){.btn .btn-sm .btn-outline-secondary role="button"}
