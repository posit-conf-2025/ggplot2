...
# programmtically
download.file("https://raw.githubusercontent.com/posit-conf-2025/ggplot2/refs/heads/main/assets/Cirquee.otf", "Cirquee.otf")
...
## Exercise 2: Basic markdown formatting with marquee

### A
Create a marquee text that uses various formatting options like bold, italic, lists, and emojis. Display it using `grid::grid.draw(marquee_grob())`. Include at least three different types of formatting.

### B
Create a marquee text that uses custom spans to change text colors, sizes, and add superscripts or subscripts. Create a chemistry formula (like H₂O or CO₂) using subscripts.

## Exercise 3: Advanced marquee styling
...
## Exercise 4: Using geom_marquee() in ggplot2
