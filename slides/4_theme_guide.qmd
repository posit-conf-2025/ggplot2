...
p +
  aes(shape = factor(year), colour = class) +
  guides(
    x = guide_axis(
      theme = theme_classic(ink = "red")
    ),
    y = guide_axis(
      theme = theme_minimal(ink = "blue")
    ),
    shape = guide_legend(
      theme = theme_gray(paper = "cornsilk")
    ),
    colour = guide_legend(
...
::: {.r-stack}
[![](https://github.com/teunbrand/legendry/blob/main/man/figures/logo.png?raw=true){width="400"}](https://teunbrand.github.io/legendry/)
:::
