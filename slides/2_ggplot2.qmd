...
<!-- The code and plot kinda overflows the slide here -->
...
<!--  Do we really advocate this? When setting aesthetics rather than mapping them we generally say "only a single value", right? -->
...
<!-- The title overflows in the plot -->
