...
my_theme <- function(...) {
  theme_gray() + theme(geom = element_geom(ink = "red"))
}
...
scale_x_asinh <- function(...) {
  scale_x_continuous(transform = scales::transform_asinh())
}
...
## [Exercise](../exercises/6_extensions.qmd#exercise-6-extension) {.center style="text-align:center;"}
