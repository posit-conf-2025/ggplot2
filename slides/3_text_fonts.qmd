...
## [Exercise](../exercises/3_text_fonts.qmd#basic-markdown-formatting-with-marquee) {.center style="text-align:center;"}
...
sf[grepl("monte", sf$family, ignore.case = TRUE),]
...
## [Exercise](../exercises/3_text_fonts.qmd#advanced-marquee-styling) {.center style="text-align:center;"}
...
## [Exercise](../exercises/3_text_fonts.qmd#using-geom_marquee-in-ggplot2) {.center style="text-align:center;"}
