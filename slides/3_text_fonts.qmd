...
:::: r-stack
[![https://www.tidyverse.org/blog/2025/05/fonts-in-r/](../assets/img/blogpost.png){width=800 style="max-width:100%;"}](https://www.tidyverse.org/blog/2025/05/fonts-in-r/)
::::

## [Exercise 3.1](https://posit-conf-2025.github.io/ggplot2/exercises/3_text_fonts.qmd#working-with-fonts) {.center style="text-align:center;"}
...
* [ggtext](https://wilkelab.org/ggtext/) by Claus Wilke
...
* [marquee](https://marquee.r-lib.org) by me
...
```{r}
text <- "
Some {.red *red* text} and some {#00FF00 *green*
text} walked into a {.30 huge} bar and said to 
the {.person barman}: ”Can I get a glass of 
H{.sub 2}O?”
"
...
## [Exercise 3.2](https://posit-conf-2025.github.io/ggplot2/exercises/3_text_fonts.html#basic-markdown-formatting-with-marquee) {.center style="text-align:center;"}
...
* Each tag can be styled with `r length(classic_style()[[1]]$base)` different properties
  ```{r}
  #| output-location: default
...
## [Exercise 3.3](https://posit-conf-2025.github.io/ggplot2/exercises/3_text_fonts.qmd#advanced-marquee-styling) {.center style="text-align:center;"}
...
ggplot(
  ...
  labs(
    title = 
"An overview of various *Pygoscelis*
(penguin) species"
  ) + 
  theme(
...
## [Exercise 3.4](https://posit-conf-2025.github.io/ggplot2/exercises/3_text_fonts.qmd#using-geom_marquee-in-ggplot2) {.center style="text-align:center;"}
