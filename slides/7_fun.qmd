...
```{r}
ggplot(penguins, aes(x = flipper_len, y = bill_len)) + 
  with_shadow(geom_smooth(alpha = 1, level = 0.99), sigma = unit(0.5, "mm")) +
  with_shadow(geom_point(), sigma = unit(0.5, "mm"))
```
...
ggplot(penguins, aes(x = flipper_len, y = bill_len)) + 
  ...
  with_shadow("group_1", sigma = unit(0.5, "mm"))
```
...
## [Exercise 7.1](https://posit-conf-2025.github.io/ggplot2/exercises/7_fun.qmd#adding-effects-with-ggfx) {.center style="text-align:center;"}
...
## [Exercise 7.2](https://posit-conf-2025.github.io/ggplot2/exercises/7_fun.qmd#working-with-ggforce) {.center style="text-align:center;"}
...
## [Exercise 7.3](https://posit-conf-2025.github.io/ggplot2/exercises/7_fun.qmd#animating-with-gganimate) {.center style="text-align:center;"}
